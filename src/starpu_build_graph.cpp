...
for (int gate_index = 1; gate_index <= BCnetlist.gate_vector.size();
	...
	if (gate.name == "NOT") {
		...
		starpu_task_insert(&clHomNOT, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_PRIORITY, 0, 0);
	}
		...
		// 2 input gates
		if (gate.name == "NAND")
			starpu_task_insert(&clHomNAND, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "NOR")
			starpu_task_insert(&clHomNOR, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "XNOR")
			starpu_task_insert(&clHomXNOR, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "AND")
			starpu_task_insert(&clHomAND, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "OR")
			starpu_task_insert(&clHomOR, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "XOR")
			starpu_task_insert(&clHomXOR, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "ANDYN")
			starpu_task_insert(&clHomANDYN, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else if (gate.name == "ORYN")
			starpu_task_insert(&clHomORYN, STARPU_W, outcipher, STARPU_R, inacipher, STARPU_R, inbcipher, STARPU_PRIORITY, 1, 0);
		else {
		...
		if (gate.name == "MUX")
			starpu_task_insert(&clHomMUX, STARPU_W, outcipher, STARPU_R, inscipher, STARPU_R, inbcipher, STARPU_R, inacipher, STARPU_PRIORITY, 0, 0);
		else if(gate.name == "NMUX")
			starpu_task_insert(&clHomNMUX, STARPU_W, outcipher, STARPU_R, inscipher, STARPU_R, inbcipher, STARPU_R, inacipher, STARPU_PRIORITY, 0, 0);
		// #ifdef USE_M12
